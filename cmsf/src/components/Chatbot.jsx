...
const Chatbot = () => {
  ...
  async function generateAnswer(e) {
    ...
    try {
      const API_KEY = "AIzaSyC8GbfJopoDjPGp7w-VmbZeOdDb1IbyDFI"; // 🔹 Replace this with your actual API key
          ...
          {chatHistory.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center text-center p-6">
              <div className="bg-blue-50 rounded-xl p-8 max-w-2xl">
                ...
                <p className="text-gray-500 mt-6 text-sm">Type your question below and press Enter!</p>
              </div>
            </div>
          ) : (
